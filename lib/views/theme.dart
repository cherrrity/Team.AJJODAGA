          ...
          children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    RadioListTile(title: Text('분홍', style: TextStyle(
                    ...
                    RadioListTile(title: Text('보라', style: TextStyle(
                        color: const Color(0xff393939), fontSize: 18.0),),
                      value: Themes.purple,
                      groupValue: _themes,
                      activeColor: Colors.white,
                    ...
                    RadioListTile(title: Text('하늘', style: TextStyle(
                        color: const Color(0xff393939), fontSize: 18.0),),
                      value: Themes.sky,
                      groupValue: _themes,
                      activeColor: Colors.white,
                    ...
                    RadioListTile(title: Text('민트', style: TextStyle(
                        color: const Color(0xff393939), fontSize: 18.0),),
                      value: Themes.mint,
                      groupValue: _themes,
                      activeColor: Colors.white,
                    ...
                    RadioListTile(title: Text('노랑', style: TextStyle(
                        color: const Color(0xff393939), fontSize: 18.0),),
                      value: Themes.yellow,
                      groupValue: _themes,
                      activeColor: Colors.white,
                    ...
                    RadioListTile(title: Text('올리브', style: TextStyle(
                        color: const Color(0xff393939), fontSize: 18.0),),
                      value: Themes.olive,
                      groupValue: _themes,
                      activeColor: Colors.white,
